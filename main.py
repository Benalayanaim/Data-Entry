...
for listing in listings:
    ...
    address = listing.address.string.strip()
    address = address.replace('|', '')
    addresses.append(address)
    price = listing.span.string
    if "+" in price:
        price = price.split('+')[0]
    else:
        price = price.split('/')[0]
...
for n in range(len(all_links)):
    ...
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSfc-k5AzZEAG4BLeLyv68TOA8lHIZnkNl9W4beAR1H4_rmFtg/viewform")
    time.sleep(2)
